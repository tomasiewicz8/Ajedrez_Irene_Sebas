...
public class Caballo implements Piezas {
	...
	/**
	 * Este metodo nos hace el movimiento del caballo, la cual se mueve en L y puede
	 * saltar otras piezas, y verifica si al recorrerla hay pieza por el camino, no
	 * se mueve
	 * 
						...
						if (mover_columna == seleccionar_columna - 1 && mover_fila == seleccionar_fila - 2) {
							...
							if (mover_columna == seleccionar_columna + 1 && mover_fila == seleccionar_fila - 2) {
								...
								if (mover_columna == seleccionar_columna - 1 && mover_fila == seleccionar_fila + 2) {
									...
									if (mover_columna == seleccionar_columna + 1
											&& mover_fila == seleccionar_fila + 2) {
