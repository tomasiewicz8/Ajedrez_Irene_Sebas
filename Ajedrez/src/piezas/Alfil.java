...
public class Alfil extends Queen {
	 ...
	 * 
	 * @param minC.. es una variable donde se guarda el valor minimo de la columna
	 *               comparado en un if, recogerá el valor o de seleccionar o de
	 *               mover para despues, tomarlo como rango para recorrerlo en el
	 *               bucle
	 * @param minF.. es una variable donde se guarda el valor minimo de la fila
	 *               comparado en un if, recogerá el valor o de seleccionar o de
	 *               mover para despues, tomarlo como rango para recorrerlo en el
	 *               bucle
	 * @param maxC.. es una variable donde se guarda el valor maximo de la columna
	 *               comparado en un if, recogerá el valor o de seleccionar o de
	 *               mover para despues, tomarlo como rango para recorrerlo en el
	 *               bucle
	 * @param maxF.. es una variable donde se guarda el valor maximo de la fila
	 *               comparado en un if, recogerá el valor o de seleccionar o de
	 *               mover para despues, tomarlo como rango para recorrerlo en el
	 *               bucle
	 */
