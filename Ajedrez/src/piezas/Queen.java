...
public class Queen implements Piezas{
	...
	public boolean mover(int mover_fila, int mover_columna, int seleccionar_columna, int seleccionar_fila, Piezas[][] tablero) {
		...
		if (colorFicha == "Blanco") {
			...
			if (movimientoValido == a.mover(mover_fila, mover_columna, seleccionar_columna, seleccionar_fila, tablero)) {
				setMovimientoValido(true);
			} else {
				if (movimientoValido == t.mover(mover_fila, mover_columna, seleccionar_columna, seleccionar_fila, tablero)) {
					setMovimientoValido(true);
				} else {
